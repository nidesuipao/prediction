...
from .model_utils import gpu, to_long,  Optimizer
...
class Net(nn.Module):
    ...
    def forward(self, data: Dict) -> Dict[str, List[Tensor]]:
        ...
        # print(nodes.shape)
        # print(node_idcs[0].shape)
        # print(node_ctrs[0].shape)
...
def graph_gather(graphs):
    ...
    # print(len(graphs[0]['ctrs']))
    # print(len(graphs[1]['ctrs']))
    for i in range(batch_size):
        counts.append(count)
