...
if __name__ == "__main__":
    ...
    model = HGNN(in_channels, out_channels,3,1,64,64,64)
    ...
    for epoch in range(epochs):
        ...
        if (epoch+1) % val_every == 0 and (not epoch < end_epoch):
            ...
            print(f"minADE:{metrics['minADE']:3f}, minFDE:{metrics['minFDE']:3f}, MissRate:{metrics['MR']:3f}, Val_loss:{val_loss:3f}")
