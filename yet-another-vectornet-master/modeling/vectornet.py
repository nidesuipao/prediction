...
class HGNN(nn.Module):
    ...
    def forward(self, x, edge_index, y, cluster, valid_len, time_step_len, batch, ptr):
        """
        args: 
        ...
        sub_graph_out = self.subgraph(x, edge_index, batch, cluster)
